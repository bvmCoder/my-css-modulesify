...
var _indexJs = require('mdc-css-modules-loader-core');
...
var FileSystemLoader = (function () {
  function FileSystemLoader(root, plugins, opts) {
    _classCallCheck(this, FileSystemLoader);

    this.root = root;
    this.sources = {};
    this.importNr = 0;
    this.core = new _indexJs2['default'](plugins, opts);
    this.tokensByFile = {};
    ...
    value: function fetch(_newPath, relativeTo, _trace) {
      ...
      return new Promise(function (resolve, reject) {
        ...
        _fs2['default'].readFile(fileRelativePath, 'utf-8', function (err, source) {
          if (err) reject(err);
          _this.core.load(source, fileRelativePath /* rootRelativePath */, trace, _this.fetch.bind(_this)).then(function (_ref) {
